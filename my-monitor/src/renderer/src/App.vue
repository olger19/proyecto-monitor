...
<template>
  <div class="text-on-surface bg-background min-h-screen font-body flex">
    ...
    >
      <!-- Brand Section -->
      <div class="mb-2">
        <h1 class="text-blue-400 font-headline font-bold text-xl tracking-tighter">
          The Digital Curator
        </h1>
        <p class="text-on-surface-variant text-xs opacity-70">Network Intelligence</p>
      </div>

      <!-- Main Navigation Tabs -->
      <div class="flex flex-col space-y-2 flex-grow">
        <a
          class="flex items-center space-x-3 px-4 py-3 text-blue-400 font-bold bg-slate-800/50 rounded-xl"
          href="#"
        >
        ...
        <a
          class="flex items-center space-x-3 px-4 py-3 text-slate-400 hover:text-blue-400 transition-all"
          href="#"
        >
      ...
      <div class="pt-24 pb-12 px-12 max-w-7xl mx-auto space-y-12">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div class="space-y-4">
              ...
              <p class="text-sm text-on-surface-variant">
                Conectando vía Nodo de Prueba óptimo. La intensidad de la señal es óptima a -42dBm.
              </p>
            </div>
            <div class="pt-6">
              <div class="h-1.5 w-full bg-slate-800 rounded-full overflow-hidden">
                <div class="h-full bg-primary w-[92%] shadow-[0_0_8px_rgba(59,130,246,0.4)]"></div>
              </div>
        ...
        <section class="space-y-6">
          ...
          >
            ...
            <!-- Fallback if empty -->
            <div v-if="historicalPeaks.length === 0" class="px-8 py-12 text-center text-slate-500">
